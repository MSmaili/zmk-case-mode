...
Ready to use after including the dtsi. All pre-defined behaviors include numbers (0-9) in their continue-list.
Create your own behavior if you want to exclude them or have specific needs.
...
| ------------------ | ------- | ------- | -------------------------------------------------------------- |
| `delimiter`        | int     | none    | Keycode emitted on space (e.g. `UNDERSCORE`, `MINUS`, `DOT`)   |
